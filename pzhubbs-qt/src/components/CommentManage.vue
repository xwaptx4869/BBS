<template>
  <div class="comment-page">
    <div v-if="data" class="comments-content">
      <el-badge :value="data.length " :max="99">
      ...
      <div class="comments-list">
        <div class="comment" v-for=" (item,index) in data" :key="index">
          ...
          <div class="comment-content">
            ...
            <el-button size="mini" type="primary" @click="ifreply = true;secondifreply = false; clickindex = index;">回复</el-button>
          </div>
          <div v-if="item.replylist" class="secondlevelreply-box">
            <div v-for=" (ite,inde) in item.replylist" :key="inde" class="reply-list">
              ...
              <div class="reply-content">
                ...
                <el-button size="mini" type="primary" @click="ifreply = false;;secondifreply = true; secondclick = inde;">回复</el-button>
              </div>
